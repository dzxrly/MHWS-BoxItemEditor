...
function M.mainWindow()
    if imgui.begin_window(
        ...
        if imgui.begin_table("table_backup_warning", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
            imgui.text_colored(i18n.getUIText("backupSaveWarning"), config.ERROR_COLOR)
            imgui.end_table()
        end

        if imgui.begin_table("table_read_box_btn", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
        ...
        if imgui.begin_table("table_edit_item_title", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
            imgui.text(i18n.getUIText("changeItemNumTitle"))
            imgui.end_table()
        end

        if imgui.begin_table("table_item_filters", 2, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
        ...
        if imgui.begin_table("table_item_combo", 1, ImGuiTableFlags_NoSavedSettings) then
        ...
        if imgui.begin_table("table_item_amount_btns", 2, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
        ...
        if imgui.begin_table("table_item_amount_input", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
        ...
        if imgui.begin_table("table_item_confirm_btn", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
        ...
        if imgui.begin_table("table_money_pts_title", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
        ...
        if imgui.begin_table("table_money_current", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
        ...
        if imgui.begin_table("table_money_edit", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
        ...
        if imgui.begin_table("table_money_edit_btn_group_add", #config.MONEY_PTS_ADD_VALUES, ImGuiTableFlags_NoSavedSettings) then
        ...
        if imgui.begin_table("table_money_edit_btn_group_sub", #config.MONEY_PTS_ADD_VALUES, ImGuiTableFlags_NoSavedSettings) then
            for btnIdx = 1, #config.MONEY_PTS_ADD_VALUES do
                imgui.table_next_column()
                imgui.begin_disabled(
                    not isInRange(
        ...
        if imgui.begin_table("table_money_confirm_btn", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
        ...
        if imgui.begin_table("table_pts_current", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
        ...
        if imgui.begin_table("table_pts_edit", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
        ...
        if imgui.begin_table("table_pts_edit_btn_group_add", #config.MONEY_PTS_ADD_VALUES, ImGuiTableFlags_NoSavedSettings) then
            for btnIdx = 1, #config.MONEY_PTS_ADD_VALUES do
                imgui.table_next_column()
                imgui.begin_disabled(
                    not isInRange(
        ...
        if imgui.begin_table("table_pts_edit_btn_group_sub", #config.MONEY_PTS_ADD_VALUES, ImGuiTableFlags_NoSavedSettings) then
            for btnIdx = 1, #config.MONEY_PTS_ADD_VALUES do
                imgui.table_next_column()
                imgui.begin_disabled(
                    not isInRange(
        ...
        if imgui.begin_table("table_pts_confirm_btn", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
        ...
        if imgui.begin_table("table_name_reset_title", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
        ...
        if imgui.begin_table("table_hunter_name_input", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
        ...
        if imgui.begin_table("table_hunter_name_confirm_btn", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
        ...
        if imgui.begin_table("table_otomo_name_input", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
        ...
        if imgui.begin_table("table_otomo_name_confirm_btn", 1, ImGuiTableFlags_NoSavedSettings) then
            imgui.table_next_column()
